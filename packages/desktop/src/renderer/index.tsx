...
// This review application does not upload renderer telemetry or crash reports.
...
const createPlatform = (windowState: DesktopWindowState): Platform => {
  ...
  const wslServersApi = undefined // Physical projects use operator SSH profiles; no unreviewed WSL agent servers.
